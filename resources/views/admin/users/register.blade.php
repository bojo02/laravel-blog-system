<x-admin>
    <main class="main users chart-page" id="skip-target">
        <div class="container">
          <h2 class="main-title">Create a new User</h2>

          <form class="form" action="{{route('user.admin.store')}}" method="POST" enctype="multipart/form-data">
            @CSRF
            <label class="form-label-wrapper">
              <p class="form-label">Name</p>
              <input name="name" class="form-input" value="{{old('name')}}" type="text" placeholder="Enter First Name">
                @error('name')
            ...
            <label class="form-label-wrapper">
                ...
                <input name="lastname" class="form-input" value="{{old('lastname')}}" type="text" placeholder="Enter Last Name">
                  @error('lastname')
                      <div class="alert alert-danger alert-dismissible fade show" role="alert">
                      {{$message}}
                          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              ...
              <div class="form-check form-switch mb-3 mt-3">
                <input name="is_admin" class="form-check-input" type="checkbox" id="flexSwitchCheckDefault">
